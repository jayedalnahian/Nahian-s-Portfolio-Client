  ...
  if (loading) return (
    <div className="min-h-screen flex items-center justify-center bg-[#EFE4D2]">
      <div className="text-center">
        ...
        <p className="mt-4 text-lg text-[#254D70]">Loading project details...</p>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        {/* Title */}
        <motion.div className="mb-12 text-center" variants={fadeInUp} custom={0}>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-start mb-16">
          ...
          <motion.div className="space-y-6" variants={fadeInUp} custom={2}>
            ...
            <div className="bg-white/50 p-5 rounded-lg shadow-sm">
              <h3 className="font-semibold text-[#131D4F] mb-3 text-xl">Technologies Used</h3>
        ...
        <div className="space-y-12">
          ...
          {project.features?.length > 0 && (
            <motion.div className="bg-white/50 p-6 md:p-8 rounded-xl shadow-sm" variants={fadeInUp} custom={3}>
                ...
                {project.features.map((feature, i) => (
                  <li key={i} className="flex items-start gap-3">
                    <div className="mt-1 flex-shrink-0">
                      <svg className="h-5 w-5 text-[#954C2E]" viewBox="0 0 20 20" fill="currentColor">
          ...
          {/* Challenges */}
          {project.challenges && (
            <motion.div className="bg-white/50 p-6 md:p-8 rounded-xl shadow-sm" variants={fadeInUp} custom={4}>
              <h3 className="text-2xl font-semibold text-[#131D4F] mb-4 pb-2 border-b border-[#254D70]/20">
          ...
          {/* Future Plans */}
          {project.futurePlans && (
            <motion.div className="bg-white/50 p-6 md:p-8 rounded-xl shadow-sm" variants={fadeInUp} custom={5}>
              <h3 className="text-2xl font-semibold text-[#131D4F] mb-4 pb-2 border-b border-[#254D70]/20">
                Future Enhancements
              </h3>
              <div className="prose max-w-none text-[#254D70]">
        ...
        {/* Back button */}
        <motion.div className="mt-16 text-center" variants={fadeInUp} custom={6}>
          <Link 
            to="/"
